...
class AttendanceCharts extends StatefulWidget {
  ...
  final AttendanceSummeryModel? summery;
...
class _AttendanceChartsState extends State<AttendanceCharts> {
  ...
  Widget build(BuildContext context) {
    var sc_width = MediaQuery.of(context).size.height;

    final Result? attendanceResult = widget.summery?.result?.firstWhere(
    ...
    final dataset =
        attendanceResult.mainChart?.datasets?[widget.selectedDuration]?[0];

    final labels = attendanceResult.mainChart?.labels ?? [];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Text(
                  "${attendanceResult.title} - ${attendanceResult.ranges?[widget.selectedDuration] ?? ''}",
                  style: TextStyle(
                    fontSize: 18,
              ...
              // Placeholder for attendance summary content
                ...
                child: PieChart(
                  PieChartData(
                    ...
                    sections: List.generate(values.length, (i) {
                      ...
                      final radius = isTouched ? sc_width / 10 : sc_width / 11;
                      // Combine count + label
              ...
              Padding(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children:
                      attendanceResult.footer?.map((footerItem) {
                        String count = "0";
